...
namespace NeoEdit.TextEditor
{
	enum TextEditCommand
	{
		...
		[Header("MD5")] Files_Checksum_MD5,
		[Header("SHA1")] Files_Checksum_SHA1,
		[Header("SHA256")] Files_Checksum_SHA256,
		...
		[Header("Base64")] Data_Binary_ToBinary_Base64,
		[Header("UInt8LE")] Data_Binary_ToBinary_UInt8LE,
		[Header("UInt16LE")] Data_Binary_ToBinary_UInt16LE,
		[Header("UInt32LE")] Data_Binary_ToBinary_UInt32LE,
		[Header("UInt64LE")] Data_Binary_ToBinary_UInt64LE,
		[Header("Int8LE")] Data_Binary_ToBinary_Int8LE,
		[Header("Int16LE")] Data_Binary_ToBinary_Int16LE,
		[Header("Int32LE")] Data_Binary_ToBinary_Int32LE,
		[Header("Int64LE")] Data_Binary_ToBinary_Int64LE,
		[Header("UInt8BE")] Data_Binary_ToBinary_UInt8BE,
		[Header("UInt16BE")] Data_Binary_ToBinary_UInt16BE,
		[Header("UInt32BE")] Data_Binary_ToBinary_UInt32BE,
		[Header("UInt64BE")] Data_Binary_ToBinary_UInt64BE,
		[Header("Int8BE")] Data_Binary_ToBinary_Int8BE,
		[Header("Int16BE")] Data_Binary_ToBinary_Int16BE,
		[Header("Int32BE")] Data_Binary_ToBinary_Int32BE,
		[Header("Int64BE")] Data_Binary_ToBinary_Int64BE,
		[Header("Single")] Data_Binary_ToBinary_Single,
		[Header("Double")] Data_Binary_ToBinary_Double,
		...
		[Header("Base64")] Data_Binary_FromBinary_Base64,
		[Header("UInt8LE")] Data_Binary_FromBinary_UInt8LE,
		[Header("UInt16LE")] Data_Binary_FromBinary_UInt16LE,
		[Header("UInt32LE")] Data_Binary_FromBinary_UInt32LE,
		[Header("UInt64LE")] Data_Binary_FromBinary_UInt64LE,
		[Header("Int8LE")] Data_Binary_FromBinary_Int8LE,
		[Header("Int16LE")] Data_Binary_FromBinary_Int16LE,
		[Header("Int32LE")] Data_Binary_FromBinary_Int32LE,
		[Header("Int64LE")] Data_Binary_FromBinary_Int64LE,
		[Header("UInt8BE")] Data_Binary_FromBinary_UInt8BE,
		[Header("UInt16BE")] Data_Binary_FromBinary_UInt16BE,
		[Header("UInt32BE")] Data_Binary_FromBinary_UInt32BE,
		[Header("UInt64BE")] Data_Binary_FromBinary_UInt64BE,
		[Header("Int8BE")] Data_Binary_FromBinary_Int8BE,
		[Header("Int16BE")] Data_Binary_FromBinary_Int16BE,
		[Header("Int32BE")] Data_Binary_FromBinary_Int32BE,
		[Header("Int64BE")] Data_Binary_FromBinary_Int64BE,
		[Header("Single")] Data_Binary_FromBinary_Single,
		[Header("Double")] Data_Binary_FromBinary_Double,
		...
		[Header("Binary")] Data_Base64_ToBase64_Binary,
		...
		[Header("Binary")] Data_Base64_FromBase64_Binary,
		...
		[Header("_Count")] Data_Copy_Count,
		[Header("_String")] Data_Copy_Min_String,
		[Header("_Numeric")] Data_Copy_Min_Numeric,
		[Header("_String")] Data_Copy_Max_String,
		[Header("_Numeric")] Data_Copy_Max_Numeric,
		[Header("_Min")] Data_Copy_Length_Min,
		[Header("Ma_x")] Data_Copy_Length_Max,
		[Header("_Sum")] Data_Copy_Sum,
		...
		[Header("Remove")] [KeyGesture(Key.OemMinus, ModifierKeys.Alt)] Select_Remove,
