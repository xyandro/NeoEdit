	...
	public partial class TextEditorTabs
	{
		...
		void RunCommand(TextEditCommand command)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Data_Binary_ToBinary_UTF8: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF8); break;
				case TextEditCommand.Data_Binary_ToBinary_UTF7: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF7); break;
				case TextEditCommand.Data_Binary_ToBinary_UTF16LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF16LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UTF16BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF16BE); break;
				case TextEditCommand.Data_Binary_ToBinary_UTF32LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF32LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UTF32BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF32BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Base64: Active.Command_Data_Binary_ToBinary(Coder.Type.Base64); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt8LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt8LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt16LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt16LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt32LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt32LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt64LE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt64LE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int8LE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int8LE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int16LE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int16LE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int32LE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int32LE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int64LE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int64LE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt8BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt8BE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt16BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt16BE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt32BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt32BE); break;
				case TextEditCommand.Data_Binary_ToBinary_UInt64BE: Active.Command_Data_Binary_ToBinary(Coder.Type.UInt64BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int8BE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int8BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int16BE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int16BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int32BE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int32BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Int64BE: Active.Command_Data_Binary_ToBinary(Coder.Type.Int64BE); break;
				case TextEditCommand.Data_Binary_ToBinary_Single: Active.Command_Data_Binary_ToBinary(Coder.Type.Single); break;
				case TextEditCommand.Data_Binary_ToBinary_Double: Active.Command_Data_Binary_ToBinary(Coder.Type.Double); break;
				case TextEditCommand.Data_Binary_FromBinary_Auto: Active.Command_Data_Binary_FromBinary(Coder.Type.Auto); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF8: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF8); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF7: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF7); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF16LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF16LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF16BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF16BE); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF32LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF32LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UTF32BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF32BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Base64: Active.Command_Data_Binary_FromBinary(Coder.Type.Base64); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt8LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt8LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt16LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt16LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt32LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt32LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt64LE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt64LE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int8LE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int8LE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int16LE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int16LE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int32LE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int32LE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int64LE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int64LE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt8BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt8BE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt16BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt16BE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt32BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt32BE); break;
				case TextEditCommand.Data_Binary_FromBinary_UInt64BE: Active.Command_Data_Binary_FromBinary(Coder.Type.UInt64BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int8BE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int8BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int16BE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int16BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int32BE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int32BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Int64BE: Active.Command_Data_Binary_FromBinary(Coder.Type.Int64BE); break;
				case TextEditCommand.Data_Binary_FromBinary_Single: Active.Command_Data_Binary_FromBinary(Coder.Type.Single); break;
				case TextEditCommand.Data_Binary_FromBinary_Double: Active.Command_Data_Binary_FromBinary(Coder.Type.Double); break;
				case TextEditCommand.Data_Base64_ToBase64_UTF8: Active.Command_Data_Base64_ToBase64(Coder.Type.UTF8); break;
				case TextEditCommand.Data_Base64_ToBase64_UTF7: Active.Command_Data_Base64_ToBase64(Coder.Type.UTF7); break;
				...
				case TextEditCommand.Sort_Reverse: Active.Command_Sort(TextEditor.SortScope.Selections, TextEditor.SortType.Reverse, include); break;
				case TextEditCommand.Sort_Randomize: Active.Command_Sort(TextEditor.SortScope.Selections, TextEditor.SortType.Randomize, include); break;
				case TextEditCommand.Sort_Length: Active.Command_Sort(TextEditor.SortScope.Selections, TextEditor.SortType.Length, include); break;
				case TextEditCommand.Sort_Lines_String: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.String, include); break;
				case TextEditCommand.Sort_Lines_Numeric: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Numeric, include); break;
				case TextEditCommand.Sort_Lines_Keys: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Keys, include); break;
				case TextEditCommand.Sort_Lines_Reverse: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Reverse, include); break;
				case TextEditCommand.Sort_Lines_Randomize: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Randomize, include); break;
				case TextEditCommand.Sort_Lines_Length: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Length, include); break;
				case TextEditCommand.Sort_Regions_String: Active.Command_Sort(TextEditor.SortScope.Regions, TextEditor.SortType.String, include); break;
				case TextEditCommand.Sort_Regions_Numeric: Active.Command_Sort(TextEditor.SortScope.Regions, TextEditor.SortType.Numeric, include); break;
				case TextEditCommand.Sort_Regions_Keys: Active.Command_Sort(TextEditor.SortScope.Regions, TextEditor.SortType.Keys, include); break;
				...
				case TextEditCommand.Sort_Regions_Length: Active.Command_Sort(TextEditor.SortScope.Regions, TextEditor.SortType.Length, include); break;
