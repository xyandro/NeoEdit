	...
	public partial class TextEditorTabs
	{
		...
		void RunCommand(TextEditCommand command)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Data_Binary_ToBinary_String_UTF7: Active.Command_Data_Binary_ToBinary(Coder.Type.UTF7); break;
				...
				case TextEditCommand.Data_Binary_FromBinary_String_Auto: Active.Command_Data_Binary_FromBinary(Coder.Type.Auto); break;
				case TextEditCommand.Data_Binary_FromBinary_String_UTF8: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF8); break;
				case TextEditCommand.Data_Binary_FromBinary_String_UTF7: Active.Command_Data_Binary_FromBinary(Coder.Type.UTF7); break;
				...
				case TextEditCommand.Sort_SortByLength: Active.Command_Sort(TextEditor.SortScope.Selections, TextEditor.SortType.Length, include); break;
				...
				case TextEditCommand.Sort_Lines_SortByLength: Active.Command_Sort(TextEditor.SortScope.Lines, TextEditor.SortType.Length, include); break;
