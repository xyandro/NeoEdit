...
namespace NeoEdit
{
	namespace Win32
	{
		...
		VirtualQueryInfo::VirtualQueryInfo(shared_ptr<const Win32Lib::VirtualQueryInfo> _ptr)
		{
			ptr = new shared_ptr<const Win32Lib::VirtualQueryInfo>(_ptr);
		}
		...
		shared_ptr<const Win32Lib::VirtualQueryInfo> VirtualQueryInfo::Get()
		{
			return *ptr;
		}
	}
