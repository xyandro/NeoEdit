...
namespace NeoEdit.Common.Expressions
{
	public class ExpressionUnitsConversion
	{
		...
		static ExpressionUnitsConversion()
		{
			...
			AddConversionConstant("year", new ExpressionUnits("days"), 365.242);
			AddConversionConstant("years", new ExpressionUnits("days"), 365.242);
			AddConversionConstant("yr", new ExpressionUnits("days"), 365.242);
			AddConversionConstant("yrs", new ExpressionUnits("days"), 365.242);
			AddConversionConstant("y", new ExpressionUnits("days"), 365.242);
			...
			AddConversionConstant("lightyear", new ExpressionUnits("lightdays"), 365.242);
			AddConversionConstant("lightyears", new ExpressionUnits("lightdays"), 365.242);
			AddConversionConstant("lightyr", new ExpressionUnits("lightdays"), 365.242);
			AddConversionConstant("lightyrs", new ExpressionUnits("lightdays"), 365.242);
			AddConversionConstant("ly", new ExpressionUnits("lightdays"), 365.242);
