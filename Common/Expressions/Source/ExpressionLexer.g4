...
RPAREN        : ')' ;
COMMA         : ',' ;
METHOD        : A B S | A C O S | A S I N | A T A N | C O S | D A T E | E V A L | F A C T O R | F I L E N A M E | F R O M D A T E | F R O M W O R D S | G C F | L C M | L N | L O G | M A X | M I N | N O W | R E C I P R O C A L | R E D U C E | R O O T | S I N | S Q R T | S T R F O R M A T | T A N | T O D A T E | T O U T C D A T E | T O W O R D S | T Y P E | U T C D A T E | V A L I D R E ;
BANG          : '!' ;
EXPOP         : '^' ;
MULTOP        : [*/%] | '//' | 't*' ;
ADDOP         : [-+] | 't' ('+' | '++' | '--') ;
