...
namespace NeoEdit.Common.UnitTest
{
	public partial class UnitTest
	{
		...
		{
			var hash = new Dictionary<Compression.Type, string>
			{
			...
			foreach (var type in Helpers.GetValues<Compression.Type>())
			{
				...
				var compressedSHA1 = Hash.Get(Hash.Type.SHA1, compressed);
				...
				var decompressedSHA1 = Hash.Get(Hash.Type.SHA1, decompressed);
