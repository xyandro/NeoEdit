...
namespace NeoEdit.Common
{
	public enum NECommand
	{
		...
		[KeyGesture(Key.F4, ModifierKeys.Control)] File_Close_Active,
		File_Close_Inactive,
		...
		Edit_Undo_Text,
		Edit_Undo_Step,
		[KeyGesture(Key.Z, ModifierKeys.Control)] Edit_Undo_BetweenFiles_Text,
		[KeyGesture(Key.Z, ModifierKeys.Control | ModifierKeys.Shift)] Edit_Undo_BetweenFiles_Step,
		Edit_Undo_BetweenFiles_Sync,
		Edit_Undo_Global,
		Edit_Redo_Text,
		Edit_Redo_Step,
		[KeyGesture(Key.Y, ModifierKeys.Control)] Edit_Redo_BetweenFiles_Text,
		[KeyGesture(Key.Y, ModifierKeys.Control | ModifierKeys.Shift)] Edit_Redo_BetweenFiles_Step,
		...
		[KeyGesture(Key.N, ModifierKeys.Control | ModifierKeys.Alt)] Window_New_FromFiles_Active,
		[KeyGesture(Key.O, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Window_New_FromFiles_CopiedCut,
