...
namespace NeoEdit.Common
{
	public enum NECommand
	{
		...
		Text_Select_Repeats_BetweenFiles_Match_IgnoreCase,
		Text_Select_Repeats_BetweenFiles_Match_MatchCase,
		Text_Select_Repeats_BetweenFiles_Mismatch_IgnoreCase,
		Text_Select_Repeats_BetweenFiles_Mismatch_MatchCase,
		Text_Select_Repeats_BetweenFiles_Common_IgnoreCase,
		Text_Select_Repeats_BetweenFiles_Common_MatchCase,
		Text_Select_Repeats_BetweenFiles_NonCommon_IgnoreCase,
		Text_Select_Repeats_BetweenFiles_NonCommon_MatchCase,
		Text_Select_ByWidth,
		...
		Window_New_FromSelections_AllSelections,
		Window_New_FromSelections_EachFile,
		[KeyGesture(Key.M, ModifierKeys.Control | ModifierKeys.Shift)] Window_New_SummarizeSelections_AllSelections_IgnoreCase,
		[KeyGesture(Key.M, ModifierKeys.Control)] Window_New_SummarizeSelections_AllSelections_MatchCase,
		[KeyGesture(Key.M, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Window_New_SummarizeSelections_EachFile_IgnoreCase,
		[KeyGesture(Key.M, ModifierKeys.Control | ModifierKeys.Alt)] Window_New_SummarizeSelections_EachFile_MatchCase,
		Window_New_FromClipboard_AllSelections,
		Window_New_FromClipboard_EachFile,
