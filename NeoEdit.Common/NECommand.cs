...
namespace NeoEdit.Common
{
	public enum NECommand
	{
		...
		Select_RepeatsCaseSensitive_Files_Match,
		Select_RepeatsCaseSensitive_Files_Mismatch,
		Select_RepeatsCaseSensitive_Files_Common,
		Select_RepeatsCaseSensitive_Files_NonCommon,
		...
		Select_RepeatsCaseInsensitive_Files_Match,
		Select_RepeatsCaseInsensitive_Files_Mismatch,
		Select_RepeatsCaseInsensitive_Files_Common,
		Select_RepeatsCaseInsensitive_Files_NonCommon,
		...
		[KeyGesture(Key.A, ModifierKeys.Control | ModifierKeys.Alt)] Window_ActiveFiles,
		Window_FileIndex,
		Window_ActiveFileIndex,
		Window_Font_Size,
		Window_Font_ShowSpecial,
		Window_ViewBinary,
		Window_ViewBinaryCodePages,
		[KeyGesture(Key.A, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Window_Select_AllFiles,
		Window_Select_NoFiles,
		Window_Select_FilesWithSelections,
		Window_Select_FilesWithoutSelections,
		Window_Select_ModifiedFiles,
		Window_Select_UnmodifiedFiles,
		Window_Select_InactiveFiles,
		Window_Close_FilesWithSelections,
		Window_Close_FilesWithoutSelections,
		Window_Close_ModifiedFiles,
		Window_Close_UnmodifiedFiles,
		[KeyGesture(Key.F4, ModifierKeys.Control)] Window_Close_ActiveFiles,
		Window_Close_InactiveFiles,
		Window_WordList,
		Help_About,
		Help_Tutorial,
		Help_Update,
