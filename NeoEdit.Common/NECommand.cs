...
namespace NeoEdit.Common
{
	public enum NECommand
	{
		...
		[KeyGesture(Key.Z, ModifierKeys.Control | ModifierKeys.Alt)] Edit_Undo_BetweenFiles_Step,
		Edit_Undo_BetweenFiles_Sync,
		Edit_Undo_Global,
		Edit_Redo_Text,
		Edit_Redo_Step,
		[KeyGesture(Key.Y, ModifierKeys.Control)] Edit_Redo_BetweenFiles_Text,
		[KeyGesture(Key.Y, ModifierKeys.Control | ModifierKeys.Alt)] Edit_Redo_BetweenFiles_Step,
