...
namespace NeoEdit.TextEdit.Dialogs
{
	partial class ChooseColorDialog
	{
		...
		[DepProp]
		public byte Alpha { get { return UIHelper<ChooseColorDialog>.GetPropValue<byte>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Red { get { return UIHelper<ChooseColorDialog>.GetPropValue<byte>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Green { get { return UIHelper<ChooseColorDialog>.GetPropValue<byte>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Blue { get { return UIHelper<ChooseColorDialog>.GetPropValue<byte>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }
		[DepProp]
		public string Percent { get { return UIHelper<ChooseColorDialog>.GetPropValue<string>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }
		[DepProp]
		public bool Picking { get { return UIHelper<ChooseColorDialog>.GetPropValue<bool>(this); } set { UIHelper<ChooseColorDialog>.SetPropValue(this, value); } }

		static ChooseColorDialog() { UIHelper<ChooseColorDialog>.Register(); }

		ChooseColorDialog(string color)
		{
			InitializeComponent();
		...
		{
			var dialog = new ChooseColorDialog(color) { Owner = parent };
