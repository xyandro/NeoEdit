...
namespace NeoEdit.TextEdit
{
	enum TextEditCommand
	{
		...
		Data_Case_Proper,
		Data_Case_Toggle,
		Data_Hex_ToHex_String,
		[KeyGesture(Key.H, ModifierKeys.Control)] Data_Hex_ToHex_Int,
		Data_Hex_ToHex_UIntLE_UInt8LE,
		Data_Hex_ToHex_UIntLE_UInt16LE,
		Data_Hex_ToHex_UIntLE_UInt32LE,
		Data_Hex_ToHex_UIntLE_UInt64LE,
		Data_Hex_ToHex_IntLE_Int8LE,
		Data_Hex_ToHex_IntLE_Int16LE,
		Data_Hex_ToHex_IntLE_Int32LE,
		Data_Hex_ToHex_IntLE_Int64LE,
		Data_Hex_ToHex_UIntBE_UInt8BE,
		Data_Hex_ToHex_UIntBE_UInt16BE,
		Data_Hex_ToHex_UIntBE_UInt32BE,
		Data_Hex_ToHex_UIntBE_UInt64BE,
		Data_Hex_ToHex_IntBE_Int8BE,
		Data_Hex_ToHex_IntBE_Int16BE,
		Data_Hex_ToHex_IntBE_Int32BE,
		Data_Hex_ToHex_IntBE_Int64BE,
		Data_Hex_ToHex_Float_Single,
		Data_Hex_ToHex_Float_Double,
		Data_Hex_FromHex_String,
		[KeyGesture(Key.H, ModifierKeys.Control | ModifierKeys.Shift)] Data_Hex_FromHex_Int,
		Data_Hex_FromHex_UIntLE_UInt8LE,
		Data_Hex_FromHex_UIntLE_UInt16LE,
		Data_Hex_FromHex_UIntLE_UInt32LE,
		Data_Hex_FromHex_UIntLE_UInt64LE,
		Data_Hex_FromHex_IntLE_Int8LE,
		Data_Hex_FromHex_IntLE_Int16LE,
		Data_Hex_FromHex_IntLE_Int32LE,
		Data_Hex_FromHex_IntLE_Int64LE,
		Data_Hex_FromHex_UIntBE_UInt8BE,
		Data_Hex_FromHex_UIntBE_UInt16BE,
		Data_Hex_FromHex_UIntBE_UInt32BE,
		Data_Hex_FromHex_UIntBE_UInt64BE,
		Data_Hex_FromHex_IntBE_Int8BE,
		Data_Hex_FromHex_IntBE_Int16BE,
		Data_Hex_FromHex_IntBE_Int32BE,
		Data_Hex_FromHex_IntBE_Int64BE,
		Data_Hex_FromHex_Float_Single,
		Data_Hex_FromHex_Float_Double,
