...
namespace NeoEdit.TextEdit
{
	enum TextEditCommand
	{
		...
		[KeyGesture(Key.Left, ModifierKeys.Control | ModifierKeys.Alt)] Markup_Parent,
		...
		[KeyGesture(Key.Down, ModifierKeys.Control | ModifierKeys.Alt)] Markup_Next,
		[KeyGesture(Key.Up, ModifierKeys.Control | ModifierKeys.Alt)] Markup_Previous,
		Markup_Outer,
		Markup_Inner,
		Markup_AllInner,
