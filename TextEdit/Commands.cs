...
namespace NeoEdit.TextEdit
{
	enum TextEditCommand
	{
		...
		Markup_Children_SelfAndAll,
		[KeyGesture(Key.Right, ModifierKeys.Control | ModifierKeys.Alt)] Markup_Children_First,
		Markup_Children_Elements,
		Markup_Children_Text,
		Markup_Children_AllText,
		Markup_Children_Comments,
		Markup_Children_ByAttribute,
		Markup_Descendants_Descendants,
		Markup_Descendants_All,
		Markup_Descendants_SelfAndDescendants,
		Markup_Descendants_SelfAndAll,
		Markup_Descendants_First,
		Markup_Descendants_Elements,
		Markup_Descendants_Text,
		Markup_Descendants_AllText,
		Markup_Descendants_Comments,
		Markup_Descendants_ByAttribute,
		[KeyGesture(Key.Down, ModifierKeys.Control | ModifierKeys.Alt)] [KeyGesture(Key.Down, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift, false)] Markup_Next,
		[KeyGesture(Key.Up, ModifierKeys.Control | ModifierKeys.Alt)] [KeyGesture(Key.Up, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift, false)] Markup_Previous,
		Markup_Outer,
		Markup_Inner,
		Markup_AllInner,
		...
		Markup_Select_ByAttribute,
		Markup_Select_TopMost,
		Markup_Select_Deepest,
		Markup_Select_MaxTopMost,
