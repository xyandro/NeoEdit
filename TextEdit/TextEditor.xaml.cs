	...
	partial class TextEditor
	{
		...
		public void HandleCommand(TextEditCommand command, bool shiftDown, object dialogResult, bool? multiStatus, ref Message.OptionsEnum answer)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Diff_FixWhitespace: Command_Diff_FixWhitespace(dialogResult as DiffFixWhitespaceDialog.Result); break;
				...
				case TextEditCommand.Files_Names_MakeAbsolute: Command_Files_Names_MakeAbsolute(dialogResult as FilesNamesMakeAbsoluteDialog.Result); break;
				case TextEditCommand.Files_Names_GetUnique: Command_Files_Names_GetUnique(dialogResult as FilesNamesGetUniqueDialog.Result); break;
				...
				case TextEditCommand.Files_Set_WriteTime: Command_Files_Set_Time(TextEditor.TimestampType.Write, dialogResult as FilesSetTimeDialog.Result); break;
				case TextEditCommand.Files_Set_AccessTime: Command_Files_Set_Time(TextEditor.TimestampType.Access, dialogResult as FilesSetTimeDialog.Result); break;
				case TextEditCommand.Files_Set_CreateTime: Command_Files_Set_Time(TextEditor.TimestampType.Create, dialogResult as FilesSetTimeDialog.Result); break;
				case TextEditCommand.Files_Set_AllTimes: Command_Files_Set_Time(TextEditor.TimestampType.All, dialogResult as FilesSetTimeDialog.Result); break;
