	...
	partial class TextEditor
	{
		...
		public bool GetDialogResult(TextEditCommand command, out object dialogResult, bool? multiStatus)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Files_Select_ByVersionControlStatus: dialogResult = Command_Files_Select_ByVersionControlStatus_Dialog(); break;
				...
				case TextEditCommand.Image_GIF_Split: dialogResult = Command_Image_GIF_Split_Dialog(); break;
				...
				case TextEditCommand.Select_Parameter: dialogResult = Command_Select_Parameter_Dialog(); break;
		...
		public void HandleCommand(TextEditCommand command, bool shiftDown, object dialogResult, bool? multiStatus, AnswerResult answer)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Files_Select_CommonAncestor: Command_Files_Select_CommonAncestor(); break;
				...
				case TextEditCommand.Numeric_Fraction_Simplify: Command_Numeric_Fraction_Simplify(); break;
				...
				case TextEditCommand.Image_GIF_Split: Command_Image_GIF_Split(dialogResult as ImageGIFSplitDialog.Result); break;
				...
				case TextEditCommand.Select_Parameter: Command_Select_Parameter(dialogResult as SelectParameterDialog.Result); break;
				...
				case TextEditCommand.View_TabIndex: Command_View_TabIndex(false); break;
				case TextEditCommand.View_ActiveTabIndex: Command_View_TabIndex(true); break;
