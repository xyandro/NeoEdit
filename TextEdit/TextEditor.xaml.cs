	...
	partial class TextEditor
	{
		...
		public void HandleCommand(TextEditCommand command, bool shiftDown, object dialogResult, bool? multiStatus)
		{
			...
			switch (command)
			{
				...
				case TextEditCommand.Edit_Data_Encrypt: Command_Edit_Data_Encrypt(dialogResult as EncryptDataDialog.Result); break;
				case TextEditCommand.Edit_Data_Decrypt: Command_Edit_Data_Decrypt(dialogResult as EncryptDataDialog.Result); break;
				case TextEditCommand.Edit_Data_Sign: Command_Edit_Data_Sign(dialogResult as SignDataDialog.Result); break;
				...
				case TextEditCommand.Text_Select_WholeWord: Command_Text_Select_WholeBoundedWord(dialogResult as SelectWordDialog.Result, true); break;
				case TextEditCommand.Text_Select_BoundedWord: Command_Text_Select_WholeBoundedWord(dialogResult as SelectWordDialog.Result, false); break;
				...
				case TextEditCommand.Network_AbsoluteURL: Command_Network_AbsoluteURL(dialogResult as AbsoluteURLDialog.Result); break;
				...
				case TextEditCommand.Network_Fetch_File: Command_Network_Fetch_File(dialogResult as FetchURLDialog.Result); break;
