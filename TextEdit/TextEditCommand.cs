...
namespace NeoEdit.TextEdit
{
	public enum TextEditCommand
	{
		...
		[KeyGesture(Key.U, ModifierKeys.Control | ModifierKeys.Alt)] Select_Unique,
		[KeyGesture(Key.D, ModifierKeys.Control | ModifierKeys.Alt)] Select_Duplicates,
		Select_MatchPrevious,
		Select_NonMatchPrevious,
		Select_RepeatedLines,
		[KeyGesture(Key.B, ModifierKeys.Control)] Select_ByCount,
