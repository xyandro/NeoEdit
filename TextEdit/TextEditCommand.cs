...
namespace NeoEdit.TextEdit
{
	public enum TextEditCommand
	{
		...
		[KeyGesture(Key.Add, ModifierKeys.Control)] [KeyGesture(Key.OemPlus, ModifierKeys.Control, 2)] Numeric_Add_AddClipboard,
		[KeyGesture(Key.Subtract, ModifierKeys.Control)] [KeyGesture(Key.OemMinus, ModifierKeys.Control, 2)] Numeric_Add_SubtractClipboard,
		Numeric_Whole,
		Numeric_Fraction,
		Numeric_Floor,
		Numeric_Ceiling,
		...
		[KeyGesture(Key.D2, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values2,
		[KeyGesture(Key.D3, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values3,
		[KeyGesture(Key.D4, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values4,
		[KeyGesture(Key.D5, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values5,
		[KeyGesture(Key.D6, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values6,
		[KeyGesture(Key.D7, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values7,
		[KeyGesture(Key.D8, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values8,
		[KeyGesture(Key.D9, ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift)] Keys_Set_Values9,
		Keys_Add_Keys,
		Keys_Add_Values1,
		Keys_Add_Values2,
		Keys_Add_Values3,
		...
		Keys_Remove_Values8,
		Keys_Remove_Values9,
		[KeyGesture(Key.D1, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values1,
		[KeyGesture(Key.D2, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values2,
		[KeyGesture(Key.D3, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values3,
		[KeyGesture(Key.D4, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values4,
		[KeyGesture(Key.D5, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values5,
		[KeyGesture(Key.D6, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values6,
		[KeyGesture(Key.D7, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values7,
		[KeyGesture(Key.D8, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values8,
		[KeyGesture(Key.D9, ModifierKeys.Control | ModifierKeys.Alt)] Keys_Replace_Values9,
		...
		Region_TransformSelections_Flatten,
		Region_TransformSelections_Transpose,
		Region_TransformSelections_RotateLeft,
		Region_TransformSelections_RotateRight,
		Region_TransformSelections_Rotate180,
		Region_TransformSelections_MirrorHorizontal,
		Region_TransformSelections_MirrorVertical,
		View_Full,
		View_Grid,
		View_CustomGrid,
		View_ActiveTabs,
