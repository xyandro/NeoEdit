...
namespace NeoEdit.Editor
{
	partial class NEFile
	{
		...
		static void Configure_Content_Ancestor() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEWindow.FilesWindow.RunDialog_Configure_Content_Various_WithAttribute(EditorExecuteState.CurrentState.NEWindow.Focused.GetSelectionNodes().SelectMany(node => node.Parents()).Distinct().ToList());
		...
		static void Configure_Content_Attributes() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEWindow.FilesWindow.RunDialog_Configure_Content_Attributes(EditorExecuteState.CurrentState.NEWindow.Focused.GetSelectionNodes());
		...
		static void Configure_Content_WithAttribute() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEWindow.FilesWindow.RunDialog_Configure_Content_Various_WithAttribute(EditorExecuteState.CurrentState.NEWindow.Focused.GetSelectionNodes());
		...
		static void Configure_Content_Children_WithAttribute() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEWindow.FilesWindow.RunDialog_Configure_Content_Various_WithAttribute(EditorExecuteState.CurrentState.NEWindow.Focused.GetSelectionNodes().SelectMany(node => node.Children()).Distinct().ToList());
		...
		static void Configure_Content_Descendants_WithAttribute() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEWindow.FilesWindow.RunDialog_Configure_Content_Various_WithAttribute(EditorExecuteState.CurrentState.NEWindow.Focused.GetSelectionNodes().SelectMany(node => node.Descendants()).Distinct().ToList());
