...
namespace NeoEdit.Editor
{
	public partial class Tab : ITab
	{
		...
		public Tab(string fileName = null, string displayName = null, byte[] bytes = null, Coder.CodePage codePage = Coder.CodePage.AutoByBOM, ParserType contentType = ParserType.None, bool? modified = null, int? line = null, int? column = null, int? index = null, ShutdownData shutdownData = null)
		{
			...
			StrictParsing = true;
			tabState.undoRedo = new UndoRedo();
		...
		void Replace(IReadOnlyList<Range> ranges, IReadOnlyList<string> strs = null, ReplaceType replaceType = ReplaceType.Normal, bool tryJoinUndo = false)
		{
			...
			switch (replaceType)
			{
				case ReplaceType.Undo: UndoRedo.AddUndone(ref tabState.undoRedo, textCanvasUndoRedo); break;
				case ReplaceType.Redo: UndoRedo.AddRedone(ref tabState.undoRedo, textCanvasUndoRedo); break;
				case ReplaceType.Normal: UndoRedo.AddUndo(ref tabState.undoRedo, textCanvasUndoRedo, IsModified); break;
			}
		...
		static public IPreExecution PreExecute(EditorExecuteState state)
		{
			switch (state.Command)
			{
				...
				case NECommand.Internal_GotoTab: return PreExecute_Internal_GotoTab(state);
				...
				case NECommand.Window_Select_TabsWithoutSelections: return PreExecute_Window_Select_TabsWithWithoutSelections(state, false);
				case NECommand.Window_Select_ModifiedTabs: return PreExecute_Window_Select_ModifiedUnmodifiedTabs(state, true);
				case NECommand.Window_Select_UnmodifiedTabs: return PreExecute_Window_Select_ModifiedUnmodifiedTabs(state, false);
				case NECommand.Window_Select_InactiveTabs: return PreExecute_Window_Select_InactiveTabs(state);
				case NECommand.Window_Close_TabsWithSelections: return PreExecute_Window_Close_TabsWithWithoutSelections(state, true);
				case NECommand.Window_Close_TabsWithoutSelections: return PreExecute_Window_Close_TabsWithWithoutSelections(state, false);
				case NECommand.Window_Close_ModifiedTabs: return PreExecute_Window_Close_ModifiedUnmodifiedTabs(state, true);
				case NECommand.Window_Close_UnmodifiedTabs: return PreExecute_Window_Close_ModifiedUnmodifiedTabs(state, false);
				case NECommand.Window_Close_ActiveTabs: return PreExecute_Window_Close_ActiveInactiveTabs(state, true);
				case NECommand.Window_Close_InactiveTabs: return PreExecute_Window_Close_ActiveInactiveTabs(state, false);
		...
		void OpenFile(string fileName, string displayName = null, byte[] bytes = null, Coder.CodePage codePage = Coder.CodePage.AutoByBOM, ParserType contentType = ParserType.None, bool? modified = null, bool keepUndo = false)
		{
			...
			if (!keepUndo)
				UndoRedo.Clear(ref tabState.undoRedo);
		...
		public void ViewSetTabSize(int columns, int rows) => Tabs?.SetTabSize(columns, rows);
