...
namespace NeoEdit.Editor
{
	partial class NEFile
	{
		...
		static void Configure_Network_AbsoluteURL() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_AbsoluteURL(EditorExecuteState.CurrentState.NEFiles.Focused.GetVariables());
		...
		static void Configure_Network_Fetch_File() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_Fetch_File(EditorExecuteState.CurrentState.NEFiles.Focused.GetVariables());
		...
		static void Configure_Network_Fetch_Stream() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_Fetch_StreamPlaylist(EditorExecuteState.CurrentState.NEFiles.Focused.GetVariables(), Path.GetDirectoryName(EditorExecuteState.CurrentState.NEFiles.Focused.FileName) ?? "");
		...
		static void Configure_Network_Fetch_Playlist() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_Fetch_StreamPlaylist(EditorExecuteState.CurrentState.NEFiles.Focused.GetVariables(), null);
		...
		static void Configure_Network_Ping() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_Ping();
		...
		static void Configure_Network_ScanPorts() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_ScanPorts();
		...
		static void Configure_Network_WCF_GetConfig() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_WCF_GetConfig();
		...
		static void Configure_Network_WCF_InterceptCalls() => EditorExecuteState.CurrentState.Configuration = EditorExecuteState.CurrentState.NEFiles.FilesWindow.RunDialog_Configure_Network_WCF_InterceptCalls();
