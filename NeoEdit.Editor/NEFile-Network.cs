...
namespace NeoEdit.Editor
{
	partial class NEFile
	{
		...
		static void Configure_Network_AbsoluteURL() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_AbsoluteURL(state.NEWindow.Focused.GetVariables());
		...
		static void Configure_Network_Fetch_File() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_Fetch_File(state.NEWindow.Focused.GetVariables());
		...
		static void Configure_Network_Fetch_Stream() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_Fetch_StreamPlaylist(state.NEWindow.Focused.GetVariables(), Path.GetDirectoryName(state.NEWindow.Focused.FileName) ?? "");
		...
		static void Configure_Network_Fetch_Playlist() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_Fetch_StreamPlaylist(state.NEWindow.Focused.GetVariables(), null);
		...
		static void Configure_Network_Ping() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_Ping();
		...
		static void Configure_Network_ScanPorts() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_ScanPorts();
		...
		static void Configure_Network_WCF_GetConfig() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_WCF_GetConfig();
		...
		static void Configure_Network_WCF_InterceptCalls() => state.Configuration = state.NEWindowUI.RunDialog_Configure_Network_WCF_InterceptCalls();
		...
		void Execute_Network_WCF_InterceptCalls()
		{
			...
			state.NEWindowUI.RunDialog_Execute_Network_WCF_InterceptCalls();
