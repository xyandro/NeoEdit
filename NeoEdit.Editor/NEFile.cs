	...
	public partial class NEFile : INEFile
	{
		...
		public static IConfiguration Configure(EditorExecuteState state)
		{
			...
			switch (state.Command)
			{
				...
				case NECommand.File_Encoding_LineEndings: return Configure_File_Encoding_LineEndings(state);
				case NECommand.File_Encrypt: return Configure_File_Encrypt(state);
				case NECommand.Edit_Paste_Paste: return Configure_Edit_Paste_Paste(state);
				case NECommand.Edit_Paste_RotatePaste: return Configure_Edit_Paste_Paste(state);
				case NECommand.Edit_Find_Find: return Configure_Edit_Find_Find(state);
				case NECommand.Edit_Find_RegexReplace: return Configure_Edit_Find_RegexReplace(state);
				...
				case NECommand.Edit_Data_Hash: return Configure_Edit_Data_Hash(state);
				case NECommand.Edit_Data_Compress: return Configure_Edit_Data_Compress(state);
				case NECommand.Edit_Data_Decompress: return Configure_Edit_Data_Decompress(state);
				case NECommand.Edit_Data_Encrypt: return Configure_Edit_Data_Encrypt(state);
				case NECommand.Edit_Data_Decrypt: return Configure_Edit_Data_Decrypt(state);
				case NECommand.Edit_Data_Sign: return Configure_Edit_Data_Sign(state);
				case NECommand.Edit_Sort: return Configure_Edit_Sort(state);
				...
				case NECommand.Files_Set_Time_Create: return Configure_Files_Set_Time(state);
				case NECommand.Files_Set_Time_All: return Configure_Files_Set_Time(state);
				case NECommand.Files_Set_Attributes: return Configure_Files_Set_Attributes(state);
				case NECommand.Files_Find: return Configure_Files_Find(state);
				case NECommand.Files_Insert: return Configure_Files_Insert(state);
				case NECommand.Files_Create_FromExpressions: return Configure_Files_Create_FromExpressions(state);
				case NECommand.Files_Select_ByVersionControlStatus: return Configure_Files_Select_ByVersionControlStatus(state);
				case NECommand.Files_Hash: return Configure_Files_Hash(state);
				...
				case NECommand.Files_Operations_Copy: return Configure_Files_Operations_CopyMove(state, false);
				case NECommand.Files_Operations_Move: return Configure_Files_Operations_CopyMove(state, true);
				case NECommand.Files_Operations_Encoding: return Configure_Files_Operations_Encoding(state);
				case NECommand.Files_Operations_SplitFile: return Configure_Files_Operations_SplitFile(state);
				case NECommand.Files_Operations_CombineFiles: return Configure_Files_Operations_CombineFiles(state);
				...
				case NECommand.Text_Unicode: return Configure_Text_Unicode(state);
				case NECommand.Text_RandomText: return Configure_Text_RandomText(state);
				case NECommand.Text_ReverseRegEx: return Configure_Text_ReverseRegEx(state);
				case NECommand.Text_FirstDistinct: return Configure_Text_FirstDistinct(state);
				case NECommand.Numeric_ConvertBase: return Configure_Numeric_ConvertBase(state);
				...
				case NECommand.Numeric_Limit: return Configure_Numeric_Limit(state);
				...
				case NECommand.Image_Size: return Configure_Image_Size(state);
				...
				case NECommand.Position_Goto_Lines: return Configure_Position_Goto(state, GotoType.Line);
				case NECommand.Position_Goto_Columns: return Configure_Position_Goto(state, GotoType.Column);
				case NECommand.Position_Goto_Indexes: return Configure_Position_Goto(state, GotoType.Index);
				case NECommand.Position_Goto_Positions: return Configure_Position_Goto(state, GotoType.Position);
				...
				case NECommand.Network_FetchFile: return Configure_Network_FetchFile(state);
				case NECommand.Network_FetchStream: return Configure_Network_FetchStream(state);
				case NECommand.Network_FetchPlaylist: return Configure_Network_FetchPlaylist(state);
				...
				case NECommand.Select_Limit: return Configure_Select_Limit(state);
				case NECommand.Select_RepeatsCaseSensitive_ByCount: return Configure_Select_Repeats_ByCount(state);
				case NECommand.Select_RepeatsCaseInsensitive_ByCount: return Configure_Select_Repeats_ByCount(state);
				case NECommand.Select_Split: return Configure_Select_Split(state);
				case NECommand.Select_Selection_ToggleAnchor: return Configure_Select_Selection_ToggleAnchor(state);
				case NECommand.Window_ViewBinaryCodePages: return Configure_Window_ViewBinaryCodePages(state);
				default: return null;
			}
		}
		#endregion
		...
		public static IPreExecution PreExecute(EditorExecuteState state)
		{
			switch (state.Command)
			{
				...
				case NECommand.Select_RepeatsCaseSensitive_Files_NonCommon: return PreExecute_Select_Repeats_Files_CommonNonCommon(state, true);
				case NECommand.Select_RepeatsCaseInsensitive_Files_Match: return PreExecute_Select_Repeats_Files_MatchMismatch(state, false);
				case NECommand.Select_RepeatsCaseInsensitive_Files_Mismatch: return PreExecute_Select_Repeats_Files_MatchMismatch(state, false);
				case NECommand.Select_RepeatsCaseInsensitive_Files_Common: return PreExecute_Select_Repeats_Files_CommonNonCommon(state, false);
				case NECommand.Select_RepeatsCaseInsensitive_Files_NonCommon: return PreExecute_Select_Repeats_Files_CommonNonCommon(state, false);
				case NECommand.Select_SummarizeCaseSensitive_One: return PreExecute_Select_Summarize(state, true, false);
				case NECommand.Select_SummarizeCaseSensitive_Many: return PreExecute_Select_Summarize(state, true, true);
				case NECommand.Select_SummarizeCaseInsensitive_One: return PreExecute_Select_Summarize(state, false, false);
				case NECommand.Select_SummarizeCaseInsensitive_Many: return PreExecute_Select_Summarize(state, false, true);
				...
				case NECommand.Window_New_FromFileSelections: return PreExecute_Window_New_FromFileSelections(state);
				...
				case NECommand.Window_ActiveFiles: return PreExecute_Window_ActiveFiles(state);
				...
				case NECommand.Window_Select_AllFiles: return PreExecute_Window_Select_AllFiles(state);
				case NECommand.Window_Select_NoFiles: return PreExecute_Window_Select_NoFiles(state);
				case NECommand.Window_Select_FilesWithSelections: return PreExecute_Window_Select_FilesWithWithoutSelections(state, true);
				case NECommand.Window_Select_FilesWithoutSelections: return PreExecute_Window_Select_FilesWithWithoutSelections(state, false);
				case NECommand.Window_Select_ModifiedFiles: return PreExecute_Window_Select_ModifiedUnmodifiedFiles(state, true);
				case NECommand.Window_Select_UnmodifiedFiles: return PreExecute_Window_Select_ModifiedUnmodifiedFiles(state, false);
				case NECommand.Window_Select_InactiveFiles: return PreExecute_Window_Select_InactiveFiles(state);
				case NECommand.Window_Close_FilesWithSelections: return PreExecute_Window_Close_FilesWithWithoutSelections(state, true);
				case NECommand.Window_Close_FilesWithoutSelections: return PreExecute_Window_Close_FilesWithWithoutSelections(state, false);
				case NECommand.Window_Close_ModifiedFiles: return PreExecute_Window_Close_ModifiedUnmodifiedFiles(state, true);
				case NECommand.Window_Close_UnmodifiedFiles: return PreExecute_Window_Close_ModifiedUnmodifiedFiles(state, false);
				case NECommand.Window_Close_ActiveFiles: return PreExecute_Window_Close_ActiveInactiveFiles(state, true);
				case NECommand.Window_Close_InactiveFiles: return PreExecute_Window_Close_ActiveInactiveFiles(state, false);
				case NECommand.Window_WordList: return PreExecute_Window_WordList(state);
				...
				case NECommand.Help_Extract: return PreExecute_Help_Extract(state);
				case NECommand.Help_RunGC: return PreExecute_Help_RunGC(state);
				case NECommand.Help_CopyCommandLine: return PreExecute_Help_CopyCommandLine(state);
			}
		...
		public void Execute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Edit_ModifyRegions: Execute_Edit_ModifyRegions(state.Configuration as Configuration_Edit_ModifyRegions); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 1); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 2); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 3); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 4); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 5); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 6); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 7); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 8); break;
				case NECommand.Edit_ModifyRegions_Select_Select_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Select, 9); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 1); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 2); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 3); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 4); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 5); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 6); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 7); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 8); break;
				case NECommand.Edit_ModifyRegions_Select_Previous_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Previous, 9); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 1); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 2); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 3); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 4); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 5); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 6); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 7); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 8); break;
				case NECommand.Edit_ModifyRegions_Select_Next_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Next, 9); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 1); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 2); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 3); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 4); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 5); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 6); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 7); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 8); break;
				case NECommand.Edit_ModifyRegions_Select_Enclosing_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_Enclosing, 9); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 1); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 2); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 3); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 4); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 5); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 6); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 7); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 8); break;
				case NECommand.Edit_ModifyRegions_Select_WithEnclosing_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithEnclosing, 9); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 1); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 2); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 3); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 4); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 5); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 6); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 7); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 8); break;
				case NECommand.Edit_ModifyRegions_Select_WithoutEnclosing_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Select_WithoutEnclosing, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Set_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Set, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Clear_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Clear, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Remove_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Remove, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Add_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Add, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Unite_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Unite, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Intersect_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Intersect, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Exclude_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Exclude, 9); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 1); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 2); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 3); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 4); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 5); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 6); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 7); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 8); break;
				case NECommand.Edit_ModifyRegions_Modify_Repeat_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Modify_Repeat, 9); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 1); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 2); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 3); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 4); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 5); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 6); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 7); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 8); break;
				case NECommand.Edit_ModifyRegions_Copy_Enclosing_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_Enclosing, 9); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 1); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 2); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 3); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 4); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 5); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 6); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 7); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 8); break;
				case NECommand.Edit_ModifyRegions_Copy_EnclosingIndex_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Copy_EnclosingIndex, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_Flatten_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Flatten, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_Transpose_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Transpose, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateLeft_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateLeft, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_RotateRight_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_RotateRight, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_Rotate180_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_Rotate180, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorHorizontal_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorHorizontal, 9); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region1: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 1); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region2: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 2); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region3: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 3); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region4: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 4); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region5: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 5); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region6: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 6); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region7: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 7); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region8: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 8); break;
				case NECommand.Edit_ModifyRegions_Transform_MirrorVertical_Region9: Execute_Edit_ModifyRegions(Configuration_Edit_ModifyRegions.Actions.Transform_MirrorVertical, 9); break;
				...
				case NECommand.Select_RepeatsCaseSensitive_Files_Common: Execute_Select_Repeats_Files_CommonNonCommon(true); break;
				case NECommand.Select_RepeatsCaseSensitive_Files_NonCommon: Execute_Select_Repeats_Files_CommonNonCommon(false); break;
				...
				case NECommand.Select_RepeatsCaseInsensitive_Files_Common: Execute_Select_Repeats_Files_CommonNonCommon(true); break;
				case NECommand.Select_RepeatsCaseInsensitive_Files_NonCommon: Execute_Select_Repeats_Files_CommonNonCommon(false); break;
				...
				case NECommand.Window_FileIndex: Execute_Window_FileIndex(false); break;
				case NECommand.Window_ActiveFileIndex: Execute_Window_FileIndex(true); break;
		...
		public bool QueryUser(string name, string text, MessageOptions defaultAccept)
		{
			lock (state)
			{
				if ((!state.SavedAnswers[name].HasFlag(MessageOptions.All)) && (!state.SavedAnswers[name].HasFlag(MessageOptions.Cancel)))
					NEFiles.ShowFile(this, () => state.SavedAnswers[name] = NEFiles.FilesWindow.RunMessageDialog("Confirm", text, MessageOptions.YesNoAllCancel, defaultAccept, MessageOptions.Cancel));
