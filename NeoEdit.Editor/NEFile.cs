	...
	public partial class NEFile : INEFile
	{
		...
		public static bool PreExecute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Edit_Undo_BetweenFiles_Text: PreExecute_Edit_Undo_BetweenFiles_TextStep(true); break;
				case NECommand.Edit_Undo_BetweenFiles_Step: PreExecute_Edit_Undo_BetweenFiles_TextStep(false); break;
				case NECommand.Edit_Redo_BetweenFiles_Text: PreExecute_Edit_Redo_BetweenFiles_TextStep(true); break;
				case NECommand.Edit_Redo_BetweenFiles_Step: PreExecute_Edit_Redo_BetweenFiles_TextStep(false); break;
				case NECommand.Edit_Advanced_EscapeClearsSelections: PreExecute_Edit_Advanced_EscapeClearsSelections(); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Ordered_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Ordered_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Unordered_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Unordered_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Ordered_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Ordered_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Unordered_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Unordered_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(true); break;
				...
				case NECommand.Window_WorkMode: PreExecute_Window_WorkMode(); break;
		...
		public void Execute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Edit_Undo_Text: Execute_Edit_Undo_TextStep(true); break;
				case NECommand.Edit_Undo_Step: Execute_Edit_Undo_TextStep(false); break;
				case NECommand.Edit_Redo_Text: Execute_Edit_Redo_TextStep(true); break;
				case NECommand.Edit_Redo_Step: Execute_Edit_Redo_TextStep(false); break;
				...
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Ordered_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Ordered_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Unordered_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Matches_Unordered_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Ordered_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Ordered_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Ordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Unordered_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Diffs_Unordered_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_MatchesDiffs_Unordered_IgnoreMatchCase(false); break;
