	...
	public partial class NEFile : INEFile
	{
		...
		public static bool PreExecute()
		{
			switch (state.Command)
			{
				...
				case NECommand.File_New_FromSelections_All: return PreExecute_File_New_FromSelections_All();
				case NECommand.File_New_FromSelections_Files: return PreExecute_File_New_FromSelections_Files();
				case NECommand.File_New_FromSelections_Selections: return PreExecute_File_New_FromSelections_Selections();
				case NECommand.File_New_FromClipboard_All: return PreExecute_File_New_FromClipboard_All();
				...
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Mismatch_IgnoreCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchMismatch_IgnoreMatchCase(false);
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Mismatch_MatchCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchMismatch_IgnoreMatchCase(true);
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Match_IgnoreCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchMismatch_IgnoreMatchCase(false);
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Match_MatchCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchMismatch_IgnoreMatchCase(true);
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Mismatch_IgnoreCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchMismatch_IgnoreMatchCase(false);
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Mismatch_MatchCase: return PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchMismatch_IgnoreMatchCase(true);
				...
				case NECommand.Window_New_SummarizeSelections_Files_IgnoreCase: return PreExecute_Window_New_SummarizeSelections_AllSelectionsEachFile_IgnoreMatchCase(false, true);
				case NECommand.Window_New_SummarizeSelections_Files_MatchCase: return PreExecute_Window_New_SummarizeSelections_AllSelectionsEachFile_IgnoreMatchCase(true, true);
				case NECommand.Window_New_SummarizeSelections_Selections_IgnoreCase: return PreExecute_Window_New_SummarizeSelections_AllSelectionsEachFile_IgnoreMatchCase(false, false);
				case NECommand.Window_New_SummarizeSelections_Selections_MatchCase: return PreExecute_Window_New_SummarizeSelections_AllSelectionsEachFile_IgnoreMatchCase(true, false);
				...
				case NECommand.Window_New_FromFiles_CopiedCut: return PreExecute_Window_New_FromFiles_CopiedCut();
