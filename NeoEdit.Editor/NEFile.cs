	...
	public partial class NEFile : INEFile
	{
		...
		public static bool PreExecute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Matches_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Matches_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Diffs_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Diffs_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Matches_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Matches_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Diffs_IgnoreCase: PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Diffs_MatchCase: PreExecute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(true); break;
		...
		public void Execute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Matches_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Matches_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Diffs_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Ordered_Diffs_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_Ordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Matches_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Matches_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(true); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Diffs_IgnoreCase: Execute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(false); break;
				case NECommand.Text_Select_Repeats_BetweenFiles_Unordered_Diffs_MatchCase: Execute_Text_Select_Repeats_BetweenFiles_Unordered_MatchesDiffs_IgnoreMatchCase(false); break;
