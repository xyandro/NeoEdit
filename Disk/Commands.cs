...
namespace NeoEdit.Disk
{
	enum DiskCommand
	{
		...
		[Header("_Identify")] [KeyGesture(Key.I, ModifierKeys.Control | ModifierKeys.Shift)] File_Identify,
		[Header("_MD5")] [KeyGesture(Key.M, ModifierKeys.Control | ModifierKeys.Shift)] File_MD5,
		[Header("_SHA1")] [KeyGesture(Key.S, ModifierKeys.Control | ModifierKeys.Shift)] File_SHA1,
