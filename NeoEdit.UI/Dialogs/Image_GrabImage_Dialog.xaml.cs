...
{
	partial class Image_GrabImage_Dialog
	{
		[DepProp]
		public string GrabX { get { return UIHelper<Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabY { get { return UIHelper<Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabWidth { get { return UIHelper<Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabHeight { get { return UIHelper<Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		public NEVariables Variables { get; }

		static Image_GrabImage_Dialog() { UIHelper<Image_GrabImage_Dialog>.Register(); }

		IntPtr hook;
		readonly Win32.HookProc hookProc;
		Image_GrabImage_Dialog(NEVariables variables)
		{
			Variables = variables;
			hookProc = MouseHook;
		...
		{
			var dialog = new Image_GrabImage_Dialog(variables) { Owner = parent };
