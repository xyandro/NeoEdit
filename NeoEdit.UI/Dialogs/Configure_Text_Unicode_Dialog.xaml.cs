...
{
	partial class Configure_Text_Unicode_Dialog
	{
		...
		[DepProp]
		public string Search { get { return UIHelper<Configure_Text_Unicode_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Text_Unicode_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public BaseTypeEnum BaseType { get { return UIHelper<Configure_Text_Unicode_Dialog>.GetPropValue<BaseTypeEnum>(this); } set { UIHelper<Configure_Text_Unicode_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public CodePointData CodePoint { get { return UIHelper<Configure_Text_Unicode_Dialog>.GetPropValue<CodePointData>(this); } set { UIHelper<Configure_Text_Unicode_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public List<CodePointData> CodePointInformation { get { return UIHelper<Configure_Text_Unicode_Dialog>.GetPropValue<List<CodePointData>>(this); } set { UIHelper<Configure_Text_Unicode_Dialog>.SetPropValue(this, value); } }

		List<CodePointData> codePointInformation;

		static Configure_Text_Unicode_Dialog()
		{
			UIHelper<Configure_Text_Unicode_Dialog>.Register();
			UIHelper<Configure_Text_Unicode_Dialog>.AddCallback(x => x.BaseType, (obj, o, n) => obj.BaseTypeChanged());
			UIHelper<Configure_Text_Unicode_Dialog>.AddCallback(x => x.Search, (obj, o, n) => obj.SearchChanged());
		}

		Configure_Text_Unicode_Dialog()
		{
			InitializeComponent();
		...
		void LoadCodePointInformation()
		{
			...
			var streamName = typeof(Configure_Text_Unicode_Dialog).Assembly.GetManifestResourceNames().Where(name => name.EndsWith(".Unicode.dat")).Single();
			using (var stream = typeof(Configure_Text_Unicode_Dialog).Assembly.GetManifestResourceStream(streamName))
		...
		{
			var dialog = new Configure_Text_Unicode_Dialog { Owner = parent };
