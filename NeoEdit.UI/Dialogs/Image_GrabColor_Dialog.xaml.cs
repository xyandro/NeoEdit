...
{
	partial class Image_GrabColor_Dialog
	{
		[DepProp]
		public byte Alpha { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Red { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Green { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Blue { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public bool Tracking { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<bool>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public ObservableCollection<string> Colors { get { return UIHelper<Image_GrabColor_Dialog>.GetPropValue<ObservableCollection<string>>(this); } set { UIHelper<Image_GrabColor_Dialog>.SetPropValue(this, value); } }

		static Image_GrabColor_Dialog()
		{
			UIHelper<Image_GrabColor_Dialog>.Register();
			UIHelper<Image_GrabColor_Dialog>.AddCallback(x => x.Tracking, (obj, o, n) => obj.SetColorFromMousePosition());
		}

		IntPtr hook;
		readonly Win32.HookProc hookProc; // Must remain live while it might be called
		Image_GrabColor_Dialog(string color)
		{
			hookProc = MouseHook;
			InitializeComponent();
		...
		{
			var dialog = new Image_GrabColor_Dialog(color) { Owner = parent };
