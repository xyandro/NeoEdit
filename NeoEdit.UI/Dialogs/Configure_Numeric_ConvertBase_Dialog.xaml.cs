...
{
	partial class Configure_Numeric_ConvertBase_Dialog
	{
		[DepProp]
		public int? InputBase { get { return UIHelper<Configure_Numeric_ConvertBase_Dialog>.GetPropValue<int?>(this); } set { UIHelper<Configure_Numeric_ConvertBase_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string InputSet { get { return UIHelper<Configure_Numeric_ConvertBase_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Numeric_ConvertBase_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public int? OutputBase { get { return UIHelper<Configure_Numeric_ConvertBase_Dialog>.GetPropValue<int?>(this); } set { UIHelper<Configure_Numeric_ConvertBase_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string OutputSet { get { return UIHelper<Configure_Numeric_ConvertBase_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Numeric_ConvertBase_Dialog>.SetPropValue(this, value); } }

		static Configure_Numeric_ConvertBase_Dialog()
		{
			UIHelper<Configure_Numeric_ConvertBase_Dialog>.Register();
			UIHelper<Configure_Numeric_ConvertBase_Dialog>.AddCallback(a => a.InputBase, (obj, o, n) => obj.Update(nameof(InputBase)));
			UIHelper<Configure_Numeric_ConvertBase_Dialog>.AddCallback(a => a.InputSet, (obj, o, n) => obj.Update(nameof(InputSet)));
			UIHelper<Configure_Numeric_ConvertBase_Dialog>.AddCallback(a => a.OutputBase, (obj, o, n) => obj.Update(nameof(OutputBase)));
			UIHelper<Configure_Numeric_ConvertBase_Dialog>.AddCallback(a => a.OutputSet, (obj, o, n) => obj.Update(nameof(OutputSet)));
		}

		Configure_Numeric_ConvertBase_Dialog()
		{
			InitializeComponent();
			InputBase = 10;
			OutputBase = 16;
		...
		{
			var dialog = new Configure_Numeric_ConvertBase_Dialog { Owner = parent };
