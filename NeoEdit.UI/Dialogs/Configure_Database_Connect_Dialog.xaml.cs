...
{
	partial class Configure_Database_Connect_Dialog
	{
		[DepProp]
		ObservableCollection<DBConnectInfo> DBConnectInfos { get { return UIHelper<Configure_Database_Connect_Dialog>.GetPropValue<ObservableCollection<DBConnectInfo>>(this); } set { UIHelper<Configure_Database_Connect_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		DBConnectInfo DBConnectInfo { get { return UIHelper<Configure_Database_Connect_Dialog>.GetPropValue<DBConnectInfo>(this); } set { UIHelper<Configure_Database_Connect_Dialog>.SetPropValue(this, value); } }

		static Configure_Database_Connect_Dialog() { UIHelper<Configure_Database_Connect_Dialog>.Register(); }
		readonly string dbConfigFile = Path.Combine(Helpers.NeoEditAppData, "DBConfig.xml");

		Configure_Database_Connect_Dialog()
		{
			InitializeComponent();
		...
		{
			var dialog = new Configure_Database_Connect_Dialog { Owner = parent };
