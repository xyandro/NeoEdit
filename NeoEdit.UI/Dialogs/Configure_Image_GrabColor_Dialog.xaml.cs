...
{
	partial class Configure_Image_GrabColor_Dialog
	{
		[DepProp]
		public byte Alpha { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Red { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Green { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public byte Blue { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<byte>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public bool Tracking { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<bool>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public ObservableCollection<string> Colors { get { return UIHelper<Configure_Image_GrabColor_Dialog>.GetPropValue<ObservableCollection<string>>(this); } set { UIHelper<Configure_Image_GrabColor_Dialog>.SetPropValue(this, value); } }

		static Configure_Image_GrabColor_Dialog()
		{
			UIHelper<Configure_Image_GrabColor_Dialog>.Register();
			UIHelper<Configure_Image_GrabColor_Dialog>.AddCallback(x => x.Tracking, (obj, o, n) => obj.SetColorFromMousePosition());
		}

		IntPtr hook;
		readonly Win32.HookProc hookProc; // Must remain live while it might be called
		Configure_Image_GrabColor_Dialog(string color)
		{
			hookProc = MouseHook;
			InitializeComponent();
		...
		{
			var dialog = new Configure_Image_GrabColor_Dialog(color) { Owner = parent };
