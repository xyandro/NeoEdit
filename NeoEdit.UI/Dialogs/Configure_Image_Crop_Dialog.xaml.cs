...
{
	partial class Configure_Image_Crop_Dialog
	{
		[DepProp]
		public string XExpression { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string YExpression { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string WidthExpression { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string HeightExpression { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string AspectRatio { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string FillColor { get { return UIHelper<Configure_Image_Crop_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_Crop_Dialog>.SetPropValue(this, value); } }
		public NEVariables Variables { get; }

		static Configure_Image_Crop_Dialog()
		{
			UIHelper<Configure_Image_Crop_Dialog>.Register();
			UIHelper<Configure_Image_Crop_Dialog>.AddCallback(a => a.WidthExpression, (obj, o, n) => obj.SetWidth(o));
			UIHelper<Configure_Image_Crop_Dialog>.AddCallback(a => a.HeightExpression, (obj, o, n) => obj.SetHeight(o));
			UIHelper<Configure_Image_Crop_Dialog>.AddCallback(a => a.AspectRatio, (obj, o, n) => obj.SetAspectRatio(o));
		}

		Configure_Image_Crop_Dialog(NEVariables variables)
		{
			Variables = variables;
		...
		{
			var dialog = new Configure_Image_Crop_Dialog(variables) { Owner = parent };
	...
	internal class CropImageToggleButtonConverter : MarkupExtension, IMultiValueConverter
	{
		...
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture) => (values[0] as Configure_Image_Crop_Dialog).IsChecked(parameter as string);
