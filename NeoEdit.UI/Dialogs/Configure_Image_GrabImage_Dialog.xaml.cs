...
{
	partial class Configure_Image_GrabImage_Dialog
	{
		[DepProp]
		public string GrabX { get { return UIHelper<Configure_Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabY { get { return UIHelper<Configure_Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabWidth { get { return UIHelper<Configure_Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		[DepProp]
		public string GrabHeight { get { return UIHelper<Configure_Image_GrabImage_Dialog>.GetPropValue<string>(this); } set { UIHelper<Configure_Image_GrabImage_Dialog>.SetPropValue(this, value); } }
		public NEVariables Variables { get; }

		static Configure_Image_GrabImage_Dialog() { UIHelper<Configure_Image_GrabImage_Dialog>.Register(); }

		IntPtr hook;
		readonly Win32.HookProc hookProc;
		Configure_Image_GrabImage_Dialog(NEVariables variables)
		{
			Variables = variables;
			hookProc = MouseHook;
		...
		{
			var dialog = new Configure_Image_GrabImage_Dialog(variables) { Owner = parent };
