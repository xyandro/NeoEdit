...
namespace NeoEdit
{
	...
	std::shared_ptr<const std::vector<std::shared_ptr<const void>>> (*Win32Lib::GetAllHandles)() = Win32LibNS::Handles::Handle::GetAllHandles;
	std::shared_ptr<const std::vector<std::shared_ptr<const void>>> (*Win32Lib::GetTypeHandles)(std::shared_ptr<const std::vector<std::shared_ptr<const void>>> handles, std::wstring type) = Win32LibNS::Handles::Handle::GetTypeHandles;
	std::shared_ptr<const std::vector<std::shared_ptr<const void>>> (*Win32Lib::GetProcessHandles)(std::shared_ptr<const std::vector<std::shared_ptr<const void>>> handles, int32_t pid) = Win32LibNS::Handles::Handle::GetProcessHandles;
	std::shared_ptr<const std::vector<std::shared_ptr<const Win32Lib::HandleInfo>>> (*Win32Lib::GetHandleInfo)(std::shared_ptr<const std::vector<std::shared_ptr<const void>>> handles) = Win32LibNS::Handles::Handle::GetHandleInfo;
