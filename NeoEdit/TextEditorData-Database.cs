		...
		void Command_Database_GetSproc()
		{
			...
			foreach (var selection in Selections)
			{
				...
				try
				{
					...
					TabsParent.AddTextEditor(new TextEditorData(displayName: sproc, bytes: Coder.StringToBytes(text, Coder.CodePage.UTF8), codePage: Coder.CodePage.UTF8, contentType: ParserType.SQL, modified: false));
				}
