...
namespace NeoEdit.Program
{
	public partial class TextEditorData
	{
		...
		double xScrollValue, newXScrollValue;
		double XScrollValue
		{
			get => newXScrollValue;
		...
		double yScrollValue, newYScrollValue;
		double YScrollValue
		{
			get => newYScrollValue;
		...
		double xScrollViewport, newXScrollViewport;
		...
		double yScrollViewport, newYScrollViewport;
		...
		public void Commit()
		{
			...
			xScrollValue = newXScrollValue;
			yScrollValue = newYScrollValue;
			xScrollViewport = newXScrollViewport;
			yScrollViewport = newYScrollViewport;
		}
		...
		public void Rollback()
		{
			...
			newXScrollValue = xScrollValue;
			newYScrollValue = yScrollValue;
			newXScrollViewport = xScrollViewport;
			newYScrollViewport = yScrollViewport;
		}
