...
namespace NeoEdit.Program
{
	partial class TextEditor
	{
		...
		void Command_DateTime_ToStandard() => ReplaceSelections(Selections.AsParallel().AsOrdered().Select(range => DateTimeOffset.Parse(GetString(range)).ToString("O")).ToList());
