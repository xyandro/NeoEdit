...
namespace NeoEdit.Program
{
	partial class TextEditor
	{
		...
		void Execute_File_New_FromSelections() => GetSelectionStrings().ForEach(((str, index) => state.TabsWindow.AddTextEditor(new TextEditor(displayName: $"Selection {index + 1}", bytes: Coder.StringToBytes(str, Coder.CodePage.UTF8), codePage: Coder.CodePage.UTF8, contentType: ContentType, modified: false))));
