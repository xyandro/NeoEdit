	...
	partial class TextEditor
	{
		...
		public void HandleCommand(NECommand command, bool shiftDown, object dialogResult, bool? multiStatus, AnswerResult answer, object preResult)
		{
			...
			switch (command)
			{
				...
				case NECommand.Edit_ModifyRegions_Select_Region6: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Select, 6); break;
				...
				case NECommand.Edit_ModifyRegions_Add_Region9: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Modify_Add, 9); break;
				case NECommand.Edit_ModifyRegions_Remove_Region6: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Modify_Remove, 6); break;
				case NECommand.Edit_ModifyRegions_Remove_Region7: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Modify_Remove, 7); break;
				case NECommand.Edit_ModifyRegions_Remove_Region8: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Modify_Remove, 8); break;
				case NECommand.Edit_ModifyRegions_Remove_Region9: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Modify_Remove, 9); break;
				case NECommand.Edit_ModifyRegions_Next_Region6: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Next, 6); break;
				case NECommand.Edit_ModifyRegions_Next_Region7: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Next, 7); break;
				case NECommand.Edit_ModifyRegions_Next_Region8: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Next, 8); break;
				case NECommand.Edit_ModifyRegions_Next_Region9: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Next, 9); break;
				case NECommand.Edit_ModifyRegions_Previous_Region6: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Previous, 6); break;
				case NECommand.Edit_ModifyRegions_Previous_Region7: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Previous, 7); break;
				case NECommand.Edit_ModifyRegions_Previous_Region8: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Previous, 8); break;
				case NECommand.Edit_ModifyRegions_Previous_Region9: Command_Edit_ModifyRegions_Shortcut(EditModifyRegionsDialog.Action.Select_Previous, 9); break;
		...
		{
			var radius = Math.Min(8, Font.FontSize / 2 - 1);
			...
			foreach (var range in ranges)
			{
				...
				points.Add(new Point(drawBounds.X(startColumn), drawBounds.Y(startLine) + radius + 1));
				points.Add(new Point(drawBounds.X(startColumn), drawBounds.Y(startLine)));
				for (var line = startLine; ; ++line)
				{
					var done = line == endLine;
					var length = done ? endColumn : Data.GetLineColumnsLength(line) + 1;
					points.Add(new Point(drawBounds.X(length), drawBounds.Y(line)));
					points.Add(new Point(drawBounds.X(length), drawBounds.Y(line) + LineHeight));
					if (done)
						break;
				}
				if (endLine != startLine)
				{
					...
					points.Add(new Point(0, drawBounds.Y(startLine) + LineHeight));
				}
				points.Add(new Point(drawBounds.X(startColumn), points[points.Count - 1].Y));
				points.Add(points[0]);
