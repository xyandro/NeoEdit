	...
	partial class TextEditor
	{
		...
		public void HandleCommand(NECommand command, bool shiftDown, object dialogResult, bool? multiStatus, AnswerResult answer, object preResult)
		{
			...
			switch (command)
			{
				...
				case NECommand.Edit_ModifyRegions: Command_Edit_ModifyRegions(dialogResult as RegionModifyRegionsDialog.Result); break;
				case NECommand.Edit_ModifyRegions_Select_Region6: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Select, 6); break;
				case NECommand.Edit_ModifyRegions_Select_Region7: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Select, 7); break;
				case NECommand.Edit_ModifyRegions_Select_Region8: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Select, 8); break;
				case NECommand.Edit_ModifyRegions_Select_Region9: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Select, 9); break;
				case NECommand.Edit_ModifyRegions_Add_Region6: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Add, 6); break;
				case NECommand.Edit_ModifyRegions_Add_Region7: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Add, 7); break;
				case NECommand.Edit_ModifyRegions_Add_Region8: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Add, 8); break;
				case NECommand.Edit_ModifyRegions_Add_Region9: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Add, 9); break;
				case NECommand.Edit_ModifyRegions_Remove_Region6: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Remove, 6); break;
				case NECommand.Edit_ModifyRegions_Remove_Region7: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Remove, 7); break;
				case NECommand.Edit_ModifyRegions_Remove_Region8: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Remove, 8); break;
				case NECommand.Edit_ModifyRegions_Remove_Region9: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Modify_Remove, 9); break;
				case NECommand.Edit_ModifyRegions_Next_Region6: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Next, 6); break;
				case NECommand.Edit_ModifyRegions_Next_Region7: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Next, 7); break;
				case NECommand.Edit_ModifyRegions_Next_Region8: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Next, 8); break;
				case NECommand.Edit_ModifyRegions_Next_Region9: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Next, 9); break;
				case NECommand.Edit_ModifyRegions_Previous_Region6: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Previous, 6); break;
				case NECommand.Edit_ModifyRegions_Previous_Region7: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Previous, 7); break;
				case NECommand.Edit_ModifyRegions_Previous_Region8: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Previous, 8); break;
				case NECommand.Edit_ModifyRegions_Previous_Region9: Command_Edit_ModifyRegions_Shortcut(RegionModifyRegionsDialog.Action.Select_Previous, 9); break;
