...
namespace NeoEdit.Program
{
	public partial class TextEditor
	{
		...
		public void ExecuteCommand()
		{
			switch (state.Command)
			{
				case NECommand.Internal_Key: Command_Internal_Key((Key)state.Configuration, state.ShiftDown, state.ControlDown, state.AltDown, state.PreHandleData); break;
				case NECommand.Internal_Text: Command_Internal_Text(state.Configuration as string); break;
				...
				case NECommand.File_Save_SaveAsByExpression: Command_File_SaveCopy_SaveCopyByExpression(state.Configuration as GetExpressionDialog.Result); break;
				...
				case NECommand.File_Copy_CopyToByExpression: Command_File_SaveCopy_SaveCopyByExpression(state.Configuration as GetExpressionDialog.Result, true); break;
				...
				case NECommand.File_Operations_RenameByExpression: Command_File_Operations_RenameByExpression(state.Configuration as GetExpressionDialog.Result); break;
				...
				case NECommand.File_Operations_SetDisplayName: Command_File_Operations_SetDisplayName(state.Configuration as GetExpressionDialog.Result); break;
				...
				case NECommand.File_Encoding_Encoding: Command_File_Encoding_Encoding(state.Configuration as EncodingDialog.Result); break;
				case NECommand.File_Encoding_ReopenWithEncoding: Command_File_Encoding_ReopenWithEncoding(state.Configuration as EncodingDialog.Result); break;
				case NECommand.File_Encoding_LineEndings: Command_File_Encoding_LineEndings(state.Configuration as FileEncodingLineEndingsDialog.Result); break;
				case NECommand.File_Encrypt: Command_File_Encrypt(state.Configuration as string); break;
				...
				case NECommand.Edit_Find_Find: Command_Edit_Find_Find(state.Configuration as EditFindFindDialog.Result); break;
				case NECommand.Edit_Find_RegexReplace: Command_Edit_Find_RegexReplace(state.Configuration as EditFindRegexReplaceDialog.Result); break;
				case NECommand.Edit_CopyDown: Command_Edit_CopyDown(); break;
				case NECommand.Edit_Rotate: Command_Edit_Rotate(state.Configuration as EditRotateDialog.Result); break;
				case NECommand.Edit_Repeat: Command_Edit_Repeat(state.Configuration as EditRepeatDialog.Result); break;
				...
				case NECommand.Edit_Data_Hash: Command_Edit_Data_Hash(state.Configuration as EditDataHashDialog.Result); break;
				case NECommand.Edit_Data_Compress: Command_Edit_Data_Compress(state.Configuration as EditDataCompressDialog.Result); break;
				case NECommand.Edit_Data_Decompress: Command_Edit_Data_Decompress(state.Configuration as EditDataCompressDialog.Result); break;
				case NECommand.Edit_Data_Encrypt: Command_Edit_Data_Encrypt(state.Configuration as EditDataEncryptDialog.Result); break;
				case NECommand.Edit_Data_Decrypt: Command_Edit_Data_Decrypt(state.Configuration as EditDataEncryptDialog.Result); break;
				case NECommand.Edit_Data_Sign: Command_Edit_Data_Sign(state.Configuration as EditDataSignDialog.Result); break;
				case NECommand.Edit_Sort: Command_Edit_Sort(state.Configuration as EditSortDialog.Result); break;
				case NECommand.Edit_Convert: Command_Edit_Convert(state.Configuration as EditConvertDialog.Result); break;
				case NECommand.Edit_ModifyRegions: Command_Edit_ModifyRegions(state.Configuration as EditModifyRegionsDialog.Result); break;
				...
				case NECommand.Files_Name_MakeAbsolute: Command_Files_Name_MakeAbsolute(state.Configuration as FilesNamesMakeAbsoluteRelativeDialog.Result); break;
				case NECommand.Files_Name_MakeRelative: Command_Files_Name_MakeRelative(state.Configuration as FilesNamesMakeAbsoluteRelativeDialog.Result); break;
				case NECommand.Files_Name_GetUnique: Command_Files_Name_GetUnique(state.Configuration as FilesNamesGetUniqueDialog.Result); break;
				...
				case NECommand.Files_Set_Size: Command_Files_Set_Size(state.Configuration as FilesSetSizeDialog.Result); break;
				case NECommand.Files_Set_Time_Write: Command_Files_Set_Time(TimestampType.Write, state.Configuration as FilesSetTimeDialog.Result); break;
				case NECommand.Files_Set_Time_Access: Command_Files_Set_Time(TimestampType.Access, state.Configuration as FilesSetTimeDialog.Result); break;
				case NECommand.Files_Set_Time_Create: Command_Files_Set_Time(TimestampType.Create, state.Configuration as FilesSetTimeDialog.Result); break;
				case NECommand.Files_Set_Time_All: Command_Files_Set_Time(TimestampType.All, state.Configuration as FilesSetTimeDialog.Result); break;
				case NECommand.Files_Set_Attributes: Command_Files_Set_Attributes(state.Configuration as FilesSetAttributesDialog.Result); break;
				case NECommand.Files_Find: Command_Files_Find(state.Configuration as FilesFindDialog.Result); break;
				case NECommand.Files_Insert: Command_Files_Insert(state.Configuration as FilesInsertDialog.Result); break;
				...
				case NECommand.Files_Create_FromExpressions: Command_Files_Create_FromExpressions(state.Configuration as FilesCreateFromExpressionsDialog.Result); break;
				...
				case NECommand.Files_Select_ByVersionControlStatus: Command_Files_Select_ByVersionControlStatus(state.Configuration as FilesSelectByVersionControlStatusDialog.Result); break;
				case NECommand.Files_Hash: Command_Files_Hash(state.Configuration as FilesHashDialog.Result); break;
				case NECommand.Files_Sign: Command_Files_Sign(state.Configuration as FilesSignDialog.Result); break;
				case NECommand.Files_Operations_Copy: Command_Files_Operations_CopyMove(state.Configuration as FilesOperationsCopyMoveDialog.Result, false); break;
				case NECommand.Files_Operations_Move: Command_Files_Operations_CopyMove(state.Configuration as FilesOperationsCopyMoveDialog.Result, true); break;
				...
				case NECommand.Files_Operations_Encoding: Command_Files_Operations_Encoding(state.Configuration as FilesOperationsEncodingDialog.Result); break;
				case NECommand.Files_Operations_SplitFile: Command_Files_Operations_SplitFile(state.Configuration as FilesOperationsSplitFileDialog.Result); break;
				case NECommand.Files_Operations_CombineFiles: Command_Files_Operations_CombineFiles(state.Configuration as FilesOperationsCombineFilesDialog.Result); break;
				case NECommand.Edit_Expression_Expression: Command_Edit_Expression_Expression(state.Configuration as EditExpressionExpressionDialog.Result); break;
				case NECommand.Edit_Expression_EvaluateSelected: Command_Edit_Expression_EvaluateSelected(); break;
				case NECommand.Text_Select_Trim: Command_Text_Select_Trim(state.Configuration as TextTrimDialog.Result); break;
				case NECommand.Text_Select_ByWidth: Command_Text_Select_ByWidth(state.Configuration as TextWidthDialog.Result); break;
				case NECommand.Text_Select_WholeWord: Command_Text_Select_WholeBoundedWord(state.Configuration as TextSelectWholeBoundedWordDialog.Result, true); break;
				case NECommand.Text_Select_BoundedWord: Command_Text_Select_WholeBoundedWord(state.Configuration as TextSelectWholeBoundedWordDialog.Result, false); break;
				...
				case NECommand.Text_Width: Command_Text_Width(state.Configuration as TextWidthDialog.Result); break;
				case NECommand.Text_Trim: Command_Text_Trim(state.Configuration as TextTrimDialog.Result); break;
				case NECommand.Text_SingleLine: Command_Text_SingleLine(); break;
				case NECommand.Text_Unicode: Command_Text_Unicode(state.Configuration as TextUnicodeDialog.Result); break;
				case NECommand.Text_GUID: Command_Text_GUID(); break;
				case NECommand.Text_RandomText: Command_Text_RandomText(state.Configuration as TextRandomTextDialog.Result); break;
				case NECommand.Text_LoremIpsum: Command_Text_LoremIpsum(); break;
				case NECommand.Text_ReverseRegEx: Command_Text_ReverseRegEx(state.Configuration as TextReverseRegExDialog.Result); break;
				case NECommand.Text_FirstDistinct: Command_Text_FirstDistinct(state.Configuration as TextFirstDistinctDialog.Result); break;
				...
				case NECommand.Numeric_ConvertBase: Command_Numeric_ConvertBase(state.Configuration as NumericConvertBaseDialog.Result); break;
				...
				case NECommand.Numeric_Series_Linear: Command_Numeric_Series_LinearGeometric(state.Configuration as NumericSeriesDialog.Result, true); break;
				case NECommand.Numeric_Series_Geometric: Command_Numeric_Series_LinearGeometric(state.Configuration as NumericSeriesDialog.Result, false); break;
				case NECommand.Numeric_Scale: Command_Numeric_Scale(state.Configuration as NumericScaleDialog.Result); break;
				...
				case NECommand.Numeric_Floor: Command_Numeric_Floor(state.Configuration as NumericFloorRoundCeilingDialog.Result); break;
				case NECommand.Numeric_Ceiling: Command_Numeric_Ceiling(state.Configuration as NumericFloorRoundCeilingDialog.Result); break;
				case NECommand.Numeric_Round: Command_Numeric_Round(state.Configuration as NumericFloorRoundCeilingDialog.Result); break;
				case NECommand.Numeric_Limit: Command_Numeric_Limit(state.Configuration as NumericLimitDialog.Result); break;
				case NECommand.Numeric_Cycle: Command_Numeric_Cycle(state.Configuration as NumericCycleDialog.Result); break;
				case NECommand.Numeric_Trim: Command_Numeric_Trim(); break;
				case NECommand.Numeric_Factor: Command_Numeric_Factor(); break;
				case NECommand.Numeric_RandomNumber: Command_Numeric_RandomNumber(state.Configuration as NumericRandomNumberDialog.Result); break;
				case NECommand.Numeric_CombinationsPermutations: Command_Numeric_CombinationsPermutations(state.Configuration as NumericCombinationsPermutationsDialog.Result); break;
				case NECommand.Numeric_MinMaxValues: Command_Numeric_MinMaxValues(state.Configuration as NumericMinMaxValuesDialog.Result); break;
				case NECommand.DateTime_Now: Command_DateTime_Now(); break;
				case NECommand.DateTime_UtcNow: Command_DateTime_UtcNow(); break;
				case NECommand.DateTime_Format: Command_DateTime_Format(state.Configuration as DateTimeFormatDialog.Result); break;
				case NECommand.DateTime_ToUtc: Command_DateTime_ToUtc(); break;
				case NECommand.DateTime_ToLocal: Command_DateTime_ToLocal(); break;
				case NECommand.DateTime_ToTimeZone: Command_DateTime_ToTimeZone(state.Configuration as DateTimeToTimeZoneDialog.Result); break;
				...
				case NECommand.Image_GrabColor: Command_Image_GrabColor(state.Configuration as ImageGrabColorDialog.Result); break;
				case NECommand.Image_GrabImage: Command_Image_GrabImage(state.Configuration as ImageGrabImageDialog.Result); break;
				case NECommand.Image_AdjustColor: Command_Image_AdjustColor(state.Configuration as ImageAdjustColorDialog.Result); break;
				case NECommand.Image_AddColor: Command_Image_AddColor(state.Configuration as ImageAddOverlayColorDialog.Result); break;
				case NECommand.Image_OverlayColor: Command_Image_OverlayColor(state.Configuration as ImageAddOverlayColorDialog.Result); break;
				case NECommand.Image_Size: Command_Image_Size(state.Configuration as ImageSizeDialog.Result); break;
				case NECommand.Image_Crop: Command_Image_Crop(state.Configuration as ImageCropDialog.Result); break;
				...
				case NECommand.Image_Rotate: Command_Image_Rotate(state.Configuration as ImageRotateDialog.Result); break;
				case NECommand.Image_GIF_Animate: Command_Image_GIF_Animate(state.Configuration as ImageGIFAnimateDialog.Result); break;
				case NECommand.Image_GIF_Split: Command_Image_GIF_Split(state.Configuration as ImageGIFSplitDialog.Result); break;
				case NECommand.Table_DetectType: Command_Table_DetectType(); break;
				case NECommand.Table_Convert: Command_Table_Convert(state.Configuration as TableConvertDialog.Result); break;
				case NECommand.Table_TextToTable: Command_Table_TextToTable(state.Configuration as TableTextToTableDialog.Result); break;
				...
				case NECommand.Table_EditTable: Command_Table_EditTable(state.Configuration as TableEditTableDialog.Result); break;
				case NECommand.Table_AddHeaders: Command_Table_AddHeaders(); break;
				case NECommand.Table_AddRow: Command_Table_AddRow(); break;
				case NECommand.Table_AddColumn: Command_Table_AddColumn(state.Configuration as TableAddColumnDialog.Result); break;
				case NECommand.Table_Select_RowsByExpression: Command_Table_Select_RowsByExpression(state.Configuration as GetExpressionDialog.Result); break;
				case NECommand.Table_SetJoinSource: Command_Table_SetJoinSource(); break;
				case NECommand.Table_Join: Command_Table_Join(state.Configuration as TableJoinDialog.Result); break;
				case NECommand.Table_Transpose: Command_Table_Transpose(); break;
				case NECommand.Table_Database_GenerateInserts: Command_Table_Database_GenerateInserts(state.Configuration as TableDatabaseGenerateInsertsDialog.Result); break;
				case NECommand.Table_Database_GenerateUpdates: Command_Table_Database_GenerateUpdates(state.Configuration as TableDatabaseGenerateUpdatesDialog.Result); break;
				case NECommand.Table_Database_GenerateDeletes: Command_Table_Database_GenerateDeletes(state.Configuration as TableDatabaseGenerateDeletesDialog.Result); break;
				case NECommand.Position_Goto_Lines: Command_Position_Goto(GotoType.Line, state.ShiftDown, state.Configuration as PositionGotoDialog.Result); break;
				case NECommand.Position_Goto_Columns: Command_Position_Goto(GotoType.Column, state.ShiftDown, state.Configuration as PositionGotoDialog.Result); break;
				case NECommand.Position_Goto_Indexes: Command_Position_Goto(GotoType.Index, state.ShiftDown, state.Configuration as PositionGotoDialog.Result); break;
				case NECommand.Position_Goto_Positions: Command_Position_Goto(GotoType.Position, state.ShiftDown, state.Configuration as PositionGotoDialog.Result); break;
				...
				case NECommand.Content_Ancestor: Command_Content_Ancestor(state.Configuration as ContentAttributeDialog.Result); break;
				case NECommand.Content_Attributes: Command_Content_Attributes(state.Configuration as ContentAttributesDialog.Result); break;
				case NECommand.Content_WithAttribute: Command_Content_WithAttribute(state.Configuration as ContentAttributeDialog.Result); break;
				...
				case NECommand.Content_Children_WithAttribute: Command_Content_Children_WithAttribute(state.Configuration as ContentAttributeDialog.Result); break;
				...
				case NECommand.Content_Descendants_WithAttribute: Command_Content_Descendants_WithAttribute(state.Configuration as ContentAttributeDialog.Result); break;
				...
				case NECommand.Network_AbsoluteURL: Command_Network_AbsoluteURL(state.Configuration as NetworkAbsoluteURLDialog.Result); break;
				...
				case NECommand.Network_FetchFile: Command_Network_FetchFile(state.Configuration as NetworkFetchFileDialog.Result); break;
				case NECommand.Network_FetchStream: Command_Network_FetchStream(state.Configuration as NetworkFetchStreamDialog.Result); break;
				case NECommand.Network_FetchPlaylist: Command_Network_FetchPlaylist(state.Configuration as NetworkFetchStreamDialog.Result); break;
				...
				case NECommand.Network_Ping: Command_Network_Ping(state.Configuration as NetworkPingDialog.Result); break;
				case NECommand.Network_ScanPorts: Command_Network_ScanPorts(state.Configuration as NetworkScanPortsDialog.Result); break;
				case NECommand.Network_WCF_GetConfig: Command_Network_WCF_GetConfig(state.Configuration as NetworkWCFGetConfig.Result); break;
				case NECommand.Network_WCF_Execute: Command_Network_WCF_Execute(); break;
				case NECommand.Network_WCF_InterceptCalls: Command_Network_WCF_InterceptCalls(state.Configuration as NetworkWCFInterceptCallsDialog.Result); break;
				case NECommand.Network_WCF_ResetClients: Command_Network_WCF_ResetClients(); break;
				case NECommand.Database_Connect: Command_Database_Connect(state.Configuration as DatabaseConnectDialog.Result); break;
				...
				case NECommand.Select_Limit: Command_Select_Limit(state.Configuration as SelectLimitDialog.Result); break;
				...
				case NECommand.Select_RepeatsCaseSensitive_ByCount: Command_Select_Repeats_ByCount(state.Configuration as SelectByCountDialog.Result, true); break;
				...
				case NECommand.Select_RepeatsCaseInsensitive_ByCount: Command_Select_Repeats_ByCount(state.Configuration as SelectByCountDialog.Result, false); break;
				...
				case NECommand.Select_Split: Command_Select_Split(state.Configuration as SelectSplitDialog.Result); break;
