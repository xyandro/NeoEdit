...
namespace NeoEdit.Program
{
	partial class TextEditor
	{
		...
		ContentAttributeDialog.Result Command_Content_Ancestor_Dialog() => ContentAttributeDialog.Run(commandState.TabsWindow, GetSelectionNodes().SelectMany(node => node.Parents()).Distinct().ToList());
		...
		ContentAttributesDialog.Result Command_Content_Attributes_Dialog() => ContentAttributesDialog.Run(commandState.TabsWindow, GetSelectionNodes());
		...
		ContentAttributeDialog.Result Command_Content_WithAttribute_Dialog() => ContentAttributeDialog.Run(commandState.TabsWindow, GetSelectionNodes());
		...
		ContentAttributeDialog.Result Command_Content_Children_WithAttribute_Dialog() => ContentAttributeDialog.Run(commandState.TabsWindow, GetSelectionNodes().SelectMany(node => node.Children()).Distinct().ToList());
		...
		ContentAttributeDialog.Result Command_Content_Descendants_WithAttribute_Dialog() => ContentAttributeDialog.Run(commandState.TabsWindow, GetSelectionNodes().SelectMany(node => node.Descendants()).Distinct().ToList());
