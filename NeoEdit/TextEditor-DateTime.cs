...
namespace NeoEdit.Program
{
	partial class TextEditor
	{
		...
		DateTimeFormatDialog.Result Command_DateTime_Format_Dialog() => DateTimeFormatDialog.Run(TabsParent, Selections.Select(range => Text.GetString(range)).DefaultIfEmpty(Dater.DateTimeOffsetToString(DateTimeOffset.Now)).First());
